...
export class SisEmpresaService {
  ...
  constructor(
    ...
    private autenticacao: AutenticacaoService
      ...
      this.baseUrl = environment.baseUrl + '/sisempresa';
  }

  consultar(nome: String): Observable<SisEmpresa[]> {
  ...
  consultarTodos(): Observable<SisEmpresa[]> {
    return this.http
  ...
  create(dado: SisEmpresa): Observable<(SisEmpresa)> {
    return this.http
  ...
  update(dado: SisEmpresa): Observable<(SisEmpresa)> {
    return this.http
  ...
  delete(dado: SisEmpresa): Observable<(SisEmpresa)> {
    return this.http
